...
public class User_ValidationUC {
	...
	public boolean validate_pNumber(String s) {
	...
	public boolean validate_pWord(String s) {
		String regex ="^(?=.*[A-Z])(?=.*\\d)[A-Za-z\\d]{7,19}$";		 
		Pattern pattern = Pattern.compile(regex);
		Matcher matcher = pattern.matcher(s);
	...
	public static void main(String[] args) {
		...
		int flag_1 =0; int flag_2=0; int flag_3=0; int flag_4 =0;int flag_5=0;
		while(true){
			do {
			...
			do {
				...
				if(uc.validate_pNumber(pNumber)) {
